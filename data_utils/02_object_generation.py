...
def main():
    ...
    # Get list of available cut videos
    ...
    for case in common_cases:
        # Get all video phases for this case
        ...
        for ann in inst_json["annotations"]:
            ...
            case_objects[case][image_seconds]["objects"].append(
                {"area": ann["area"], "bbox": ann["bbox"], "segmentation": ann["segmentation"], "object_name": category_id_to_name[ann["category_id"]]}
            )
